...
┌─────────────────────────────────────────────────────────────────┐
│  Phase 6: 삼사 병렬 검토                                         │
│  사간원 (비판) | 사헌부 (규칙) | 홍문관 (학술)                     │
└─────────────────────────────────────────────────────────────────┘
    │
    ▼
Phase 7: 도화서 설계  →  Phase 8: 좌의정/우의정 심의
    │
    ▼
SAGE #2 "시행하라"
    │
    ▼
┌─────────────────────────────────────────────────────────────────┐
│  Phase 10-11: 6조 실행 (집행관 x6 → 도승지 취합)                  │
└─────────────────────────────────────────────────────────────────┘
    │
    ▼
Phase 12: 암행어사 + 교서관 감찰
    │
    ▼
SAGE #3 "완료 확인"
    │
    ▼
Phase 14: 춘추관 | 승문원 | 규장각 (기록/회고/개선)
```
